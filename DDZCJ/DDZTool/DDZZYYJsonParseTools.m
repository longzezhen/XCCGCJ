...
#import "DDZZYYJsonParseTools.h"
#import <objc/runtime.h>

@implementation DDZZYYJsonParseTools
...
+(id)populateObject:(id)obj fromDictionary:(NSDictionary *)dict exclude:(NSArray *)excludeArray {
    ...
    Class cls = [obj class];
    NSDictionary* properties = [DDZZYYJsonParseTools propertiesForClass:cls];
    ...
    for (id key in dict) {
        ...
        if ([propertyType isEqualToString:@"NSString"] \
            ...
            if ([propertyType isEqualToString:@"NSString"] == NO &&
                ...
                [DDZZYYJsonParseTools populateObject:childObj fromDictionary:value exclude:nil];
                if ([key isEqualToString:@"id"]) {
...
+(id)populateObject:(id)obj fromDictionary:(NSDictionary *)dict {
    obj = [DDZZYYJsonParseTools populateObject:obj fromDictionary:dict exclude:nil];
...
+ (id)objectWithClass:(Class)cls fromDictionary:(NSDictionary *)dict {
    ...
    [DDZZYYJsonParseTools populateObject:obj fromDictionary:dict];
    return obj;
}

+(NSMutableDictionary *)mutableDictionaryForObject:(id)obj {
    NSDictionary* propertyDict = [DDZZYYJsonParseTools propertiesForClass:[obj class]];
...
{
    NSDictionary* dict = [DDZZYYJsonParseTools dictionaryForObject:obj include:includeArray];
    return [NSMutableDictionary dictionaryWithDictionary:dict];
}

+(NSDictionary*)dictionaryForObject:(id)obj {
    NSMutableDictionary *mutableDict = [DDZZYYJsonParseTools mutableDictionaryForObject:obj];
...
+(NSArray *)arrayOfClass:(Class)cls fromArray:(NSArray *)array {
    NSMutableArray *mutableArray = [DDZZYYJsonParseTools mutableArrayOfClass:cls fromArray:array];
...
+(NSMutableArray *)mutableArrayOfClass:(Class)cls fromArray:(NSArray *)array {
    ...
    for (id item in array) {
        ...
        id obj = [DDZZYYJsonParseTools objectWithClass:cls fromDictionary:item];
...
+(id)decodeObject:(Class)clazz from:(id)object
{
    if (object && (clazz!=NULL)) {
        if(clazz == [NSDictionary class]||clazz == [NSArray class]){
            ...
            return [DDZZYYJsonParseTools objectWithClass:clazz fromDictionary:object];
        }
    }
    return nil;
}
