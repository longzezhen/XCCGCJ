...
@interface MusicPlayObj ()<AVAudioPlayerDelegate>
{
...
@implementation MusicPlayObj

+(MusicPlayObj *)initClient
{
    static MusicPlayObj *client = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        client = [[MusicPlayObj alloc] init];
        [client initCustom];
...
{
    //获取音效文件路径
    NSString *filePath = [[NSBundle mainBundle] pathForResource:@"game_click.caf" ofType:nil];
    //创建音效文件URL
